  ...
  return (
      <body className="container">
        <div className="page">
          ...
          <PopupWithForm name={`profile`} title={`Редактировать профиль`} isOpen={editProfile} onClose={closeAllPopups}
                         children={
            <>
          ...
          <PopupWithForm name={`add-element`} title={`Новое место`} isOpen={addPlace} onClose={closeAllPopups}
                         children={
            <>
              <div className="popup__input-container">
          ...
          <PopupWithForm name={`edit-avatar`} title={`Обновить аватар`} isOpen={editAvatar} onClose={closeAllPopups}
                         children={
              <div className="popup__input-container">
